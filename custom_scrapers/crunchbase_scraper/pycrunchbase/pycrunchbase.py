...
class CrunchBase(object):
    ...
    def get_node(self, node_type, uuid=None, params=None):
        ...
        """
        if uuid is None:
            node_url = self.BASE_URL + node_type
        else:
    ...
    def funding_rounds(self, starting_page=1):
        for page in itertools.count(starting_page):
            data = self.get_node('funding-rounds', params={'page': page})
